namespace 串口调试助手
{
    partial class AboutForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.richTextBox1.Size = new System.Drawing.Size(375, 256);
            this.richTextBox1.TabIndex = 2;
            this.richTextBox1.Text = "软件名称：C-Jun\'s 串口调试助手软件\n\n功能：1、基于微软的.Net技术与串口设备进行通讯，\n         主要用于串口设备调试。\n      2、除了" +
    "进行对串口收发指令以外，还需要计算温度。\n\n版本号：1.0\n\n作者：C-Jun\n\ngithub地址 ：https://github.com/JunStitch";
